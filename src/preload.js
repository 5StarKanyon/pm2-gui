...
contextBridge.exposeInMainWorld('pm2Api', {
  ...
  setEnv: (id, newEnv) => ipcRenderer.invoke('pm2-set-env', id, newEnv),
  scheduleRestart: (schedule) => ipcRenderer.invoke('schedule-pm2-restart', schedule),
  removeRestartSchedule: () => ipcRenderer.invoke('remove-pm2-restart-schedule'),
});
